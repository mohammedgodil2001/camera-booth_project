...
import * as ImagePicker from 'expo-image-picker';
import { Alert, Image, StyleSheet, Text, TouchableOpacity, View, ScrollView, Dimensions } from 'react-native';
import { router } from 'expo-router';
import { usePhotos } from '../contexts/PhotoContext';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity 
          ...
          onPress={goBackToHome}
        >
          <Svg style={styles.backArrow} width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
