...
//         <Text key={index} style={styles.verticalLetter}>
//           {letter}
//         </Text>
//       ))}
//     </View>
...
//         <Text style={styles.verticalTitle}>{renderVerticalText('htoobotohp')}</Text>
//         {/* <Text style={styles.verticalTitle}>PHOTOBOOTH</Text> */}
//       </View>
...
//         {/* <View style={styles.stripedDivider} /> */}
